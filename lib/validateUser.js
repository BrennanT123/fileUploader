...
const folderNameLengthErr = "must be be between 1 and 30 characters.";

export const validateNewFolder = [
  body("folderName")
    .notEmpty()
    .withMessage("Please fill out folder name")
    .trim()
    .matches(/^[a-zA-Z0-9 ]+$/)
    .withMessage(`Folder ${alphanumErr}`)
    .isLength({ min: 1, max: 30 })
    .withMessage(`Folder ${folderNameLengthErr}`),
];
